        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <div class="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('contact.show') }}" class="btn btn-primary px-8 py-4 text-lg hover:-translate-y-0.5">
                        Work With Us
                    </a>
                    <a href="{{ route('work') }}" class="btn px-8 py-4 text-lg border-2 border-primary text-primary hover:bg-primary hover:text-white">
                        View Our Work
                    </a>
                </div>
